        ...
        {isOpen && (
          <div className="md:hidden py-4 bg-card/95 backdrop-blur-xl rounded-2xl mt-2 border border-border/30 animate-fade-in">
            <div className="flex flex-col gap-1 px-2">
              ...
              <a
                href="#pricing"
                className="text-black bg-[#3CFF00] hover:bg-[#35e600] transition-all duration-200 text-sm font-medium py-3 px-4 rounded-xl text-center"
                onClick={() => setIsOpen(false)}
              >
                Начать
              </a>
